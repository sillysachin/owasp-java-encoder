...
/* ********  P R I V A T E   F I E L D S  ******** */  
    ...
    private static Logger logger = Logger.getLogger("org.owasp.encoder.Base64");
...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static String encodeObject( java.io.Serializable serializableObject, int options )
    {
        ...
        {
            logger.log(Level.FINE, "SECURITY_FAILURE Problem writing object", e );
            return null;
        }   // end catch
        finally
        {
    ...
    public static String encodeBytes( byte[] source, int off, int len, int options )
    {
        ...
        if( gzip == GZIP )
        {
            ...
            {
            	logger.log(Level.FINE, "SECURITY_FAILURE Problem writing gzip stream", e );
                return null;
            }   // end catch
            finally
            {
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    private static int decode4to3( byte[] source, int srcOffset, byte[] destination, int destOffset, int options )
    {
        ...
        // Remove these after checking -- for context only.
                ...
                logger.log(Level.FINE, "SECURITY_FAILURE " +  sb.toString(), e );
                return -1;
            }   // end catch
        }
    }   // end decodeToBytes
    ...
    public static byte[] decode( byte[] source, int off, int len, int options )
    {
        ...
        for( i = off; i < off+len; i++ )
        {
            ...
            {
            	logger.log(Level.FINE, "SECURITY_FAILURE Bad Base64 input character at " + i + ": " + source[i] + "(decimal)" );
                return null;
            }   // end else: 
    ...
    {   
        ...
        catch( java.io.UnsupportedEncodingException uee )
        {
            ...
            logger.log(Level.FINE, "SECURITY_FAILURE Problem decoding string using " +
    ...
    public static Object decodeToObject( String encodedObject )
    {
        ...
        {
        	logger.log(Level.FINE, "SECURITY_FAILURE Problem reading object", e );
            obj = null;
        }   // end catch
    ...
    public static byte[] decodeFromFile( String filename )
    {
        ...
        try
        {
            ...
            {
            	logger.log(Level.FINE, "SECURITY_FAILURE File is too big for this convenience method (" + file.length() + " bytes)." );
                return null;
        ...
        {
        	logger.log(Level.FINE, "SECURITY_FAILURE Error decoding from file " + filename, e );
        }   // end catch: IOException
        finally
        {
    ...
    public static String encodeFromFile( String filename )
    {
        ...
        {
        	logger.log(Level.FINE, "SECURITY_FAILURE Error encoding from file " + filename, e );
        }   // end catch: IOException
        finally
        {
    ...
    public static boolean encodeFileToFile( String infile, String outfile )
    {
        ...
        try{
        	...
        	logger.log(Level.FINE, "SECURITY_FAILURE Problem encoding file to file", exc );
        } finally{
    ...
    public static boolean decodeFileToFile( String infile, String outfile )
    {
        ...
        try{
        	...
        	logger.log(Level.FINE, "SECURITY_FAILURE Problem decoding file to file", exc );
        } finally{
            try{ in.close();  } catch( Exception exc ){}
            try{ out.close(); } catch( Exception exc ){}
        }   // end finally
